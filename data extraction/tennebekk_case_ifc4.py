...
#test
#extract file
ifc_file = ifcopenshell.open(r'C:\Users\e_ski\OneDrive\Documents\NTNU\10. semester\Masteroppgave\Study case Tennebekk\tennebekk hulldekke 2 ifc 4 forsøk 2.ifc')
...
#values a bit off from stålkonstruksjonser profiler og formler, dette er hentet fra https://eurocodeapplied.com/design/en1993/shs-design-properties
# Example access
...
def extract_beam(beam_input,index):
    ...
    if str(profile) in steel_profiles.keys():    
        area = round(steel_profiles[profile]["A"],3) * 10**-(3) #conversion 10^-3 mm^2 to m2
...
ext_elements_df.to_excel(r'C:\Users\e_ski\OneDrive\Documents\NTNU\10. semester\Masteroppgave\Study case Tennebekk\Tennebekk 4 bjelke flytta.xlsx')
