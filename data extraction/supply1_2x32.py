...
#test
#extract file
ifc_file = ifcopenshell.open(r'C:\Users\e_ski\OneDrive\Documents\NTNU\10. semester\Masteroppgave\Supply 2\SUPPLY 2 ifc2x3 4.ifc')
...
def extract_beam(beam_input,index):
    ...
    beam_dict ={" Guid ": element_guid , " Element ": beam_input , " Material ": material_name , "Quality": quality, "Material label": quality_short, " Length [ m ]": dims[-1]," Height [ m ]": dims[1] , " Width [ m ]": dims[0] , "Volume [m3]" : volume, "Area [m2]": area, "Profile" :profile, "Iy e-6 [mm4]": Iy}
...
def extract_column(col_input,index):
    ...
    col_dict ={" Guid ": element_guid , " Element ": col_input , " Material ": material_name ,"Material label": quality_short,  "Quality": quality, " Length [ m ]": dims[-1] ," Height [ m ]": dims[1] , " Width [ m ]": dims[0] , "Volume [m3]" : volume, "Area [m2]": area, "Profile" :profile, "Iy e-6 [mm4]": Iy}
    #if material_name == "N/A":
    #    None
    #else:
...
ext_elements_df.to_excel(r'C:\Users\e_ski\OneDrive\Documents\NTNU\10. semester\Masteroppgave\Supply 2\Supply 2 ifc2x3.xlsx')
